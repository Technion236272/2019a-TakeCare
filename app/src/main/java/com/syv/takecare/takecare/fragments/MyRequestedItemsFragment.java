...
public class MyRequestedItemsFragment extends SharedItemsBaseFragment {
    private static final String TAG = "MyRequestedItemsFrag";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_my_requested_items, container, false);
